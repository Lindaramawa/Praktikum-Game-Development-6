...
class PemutarMusik(Frame):
    def __init__(self,parent):
        ...
        self.nama = StringVar()
        self.nama.set("Pilih Musik Yang Akan DIputar")
    ...
    def getFile(self):
        ...
        if len(self.penampungNama)>0 :
            ...
            self.nama.set("Musik yang Sedang Diputar : "+nama)
        self.refreshKolom()
        return file
    def putarMusik(self):
        self.berakhir=True
    ...
    def tombolNext(self):
        next = Button(text="Lanjut", command=self.next)
        next.pack(side=LEFT)
    ...
    def buatTombolStop(self):
        tombol = Button(text="Berhenti", command=self.stopMusik)
        tombol.pack(side=LEFT)

    def buatOpen(self):
        tombol = Button(text="Buka", command=self.bukaFile)
        tombol.pack(side=LEFT)
